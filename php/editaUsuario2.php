...
<head>
    ...
    <title>BiblioFacíl | Editar Usuario</title>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td> <a href="edit.php"><span id="editar" class="icon-wrench"></span></a>
                             <a href="edit.php"><span id="eliminar" class="icon-bin"></span></a></td>           
                    <?php
                    }
                    ?>
                </tbody>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><label for="id_usuario"></label>
                            <input type="number" name="id_usuario" id="id_usuario"></td>
