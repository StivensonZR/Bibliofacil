...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2020 a las 04:40:09
...
(1, 'Satanás', 2, 10, 8, 1, 17, 'Estante 1, fila6', 'Tiene la caratula nueva 01', '2020-09-19'),
(2, 'De amor y de sombra', 9, 13, 8, 1, 9, 'Estante 1', 'No presenta novedad', '2020-09-19'),
(3, 'It (Eso)', 10, 13, 8, 1, 8, 'Estante 1', 'No presenta novedad', '2020-09-19'),
(4, 'Maravilloso desastre', 11, 12, 8, 1, 10, 'Estante 1', 'No presenta novedad', '2020-09-19'),
(5, 'El amor es de todos los colores', 12, 13, 8, 1, 11, 'Estante 1', 'No presenta novedad', '2020-09-19'),
...
INSERT INTO `prestamos` (`id_prestamos`, `fecha_pres`, `fecha_venc`, `fecha_entrega`, `fo_usuario`, `fo_libro`, `fo_administrador`, `estado`) VALUES
(1, '2020-04-01', '2020-04-05', '2020-10-17', 1, 1, 1, 0),
(2, '2020-04-01', '2020-04-02', '2020-10-17', 9, 2, 1, 0),
(3, '2020-04-01', '2020-04-04', '2020-10-17', 8, 3, 1, 0),
(4, '2020-04-02', '2020-04-03', NULL, 7, 4, 2, 1),
(5, '2020-04-02', '2020-04-04', '2020-10-17', 6, 5, 2, 0),
(6, '2020-04-02', '2020-04-05', NULL, 5, 6, 2, 1),
(7, '2020-04-02', '2020-04-06', NULL, 4, 7, 3, 1),
(8, '2020-04-03', '2020-04-04', NULL, 3, 8, 3, 1),
(9, '2020-04-03', '2020-04-07', NULL, 2, 9, 3, 1),
(10, '2020-08-15', '2020-08-16', NULL, 1, 1, 1, 1),
(11, '0000-00-00', '0000-00-00', NULL, 1, 1, 1, 1),
(12, '2020-08-15', '2020-08-16', NULL, 1, 1, 1, 1),
(13, '2020-08-16', '2020-08-30', NULL, 1, 1, 1, 1),
(14, '2020-08-16', '2020-08-31', NULL, 1, 1, 1, 1);

--
-- Disparadores `prestamos`
--
DELIMITER $$
CREATE TRIGGER `Entrega_Libro` BEFORE UPDATE ON `prestamos` FOR EACH ROW BEGIN
	UPDATE libro
